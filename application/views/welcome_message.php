  ...
  <div class="login-box-body">
    ...
    <form name="formlogin" id="formlogin">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="button" class="btn btn-primary btn-block btn-flat" id="login">Sign In
            <i class="fa fa-refresh fa-spin fa-fw" id="loginicon" style="margin-right: 2px;"></i></button>
        </div>
        <!-- /.col -->
      </div>
      <form>
